 ...
 * 基于注解的监听消息消费者
 */
@RocketMQMessageListener(topic = "${rocketmq.name.sync.topic}", consumerGroup = "kongquan-sync-test-group")
@Component
public class SyncConsumerService implements RocketMQListener<MessageExt> {
    ...
    public void onMessage(MessageExt messageExt) {
        System.out.println("TOPIC:kongquan-sync-test 消费者SyncConsumerService收到消息：" + JSON.parseObject(messageExt.getBody(), User.class));

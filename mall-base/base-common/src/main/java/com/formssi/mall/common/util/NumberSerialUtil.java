 ...
 * @author ld
 */
public class NumberSerialUtil {

    /**
     * 生成单号前缀
     */
    public static String getFormNoPrefix(NumberTypeEnum formNoTypeEnum) {
        //格式化时间
    ...
    public static String getCacheKey(String serialPrefix) {
        return NumberConstants.ID_GENERATOR.concat(serialPrefix);
    }
     ...
     * @return
     */
    public static String completionRandom(String serialWithPrefix, NumberTypeEnum formNoTypeEnum) {
